# You are building UI in the clonk.ai design system.

Source: https://www.clonk.ai/
Extracted by designlang on 2026-06-21.

## Brand at a glance

- title         clonk agentic dev
- page intent   landing
- material      flat
- design grade  B
...
- secondary   #dff58b
- accent      #ff7a47
- neutrals    #262626 · #ffffff · #000000 · #555555 · #f1f1f1 · #101010

## Typography

- families   __neueMontreal_8db69f · __stackSansText_3cee34 · __degularDisplay_1e8a8c
- weights    400 · 600 · 700 · 500 · 300 · 900
- base size  16px

## Spacing

- scale      2px · 48px · 56px · 64px · 80px · 96px · 112px · 127px · 160px · 173px · 178px · 200px

## Radii

- scale      7px · 11px · 14px · 18px · 22px · 26px
...
- pronoun    you-only
- headings   Title Case
- CTA verbs  what · download · yearly · monthly · join · own
...
Generated by designlang. Re-extract by running `npx designlang clonk.ai`.
